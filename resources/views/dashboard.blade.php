...
@section('title', 'Dashboard · 2026 Redesign Preview')
@section('active_page', 'dashboard')
@section('breadcrumbs', 'Workspace | Dashboard')
...
@section('content')
                    ...
                    <div class="grid">
                                ...
                                <div class="sv-radial">
                                    <div class="sv-radial-chart">
                                        <svg viewBox="0 0 80 80">
                                            ...
                                            />
                                            <circle
                                                class="radial-fill warning"
                                                cx="40"
                                                cy="40"
                                                r="32"
                                                stroke-dasharray="201.06"
                                                stroke-dashoffset="20.11"
                                            />
                                        </svg>
                        ...
                        <section class="col-6 card">
                            ...
                            >
                                <canvas
                                    data-chart-key="dashboard-monthly"
                                ></canvas>
                            </div>
                                ...
                                <div class="wx-temp-block">
                                    <div class="wx-icon">
                                        <svg viewBox="0 0 64 64">
                                            ...
                                            <path
                                                d="M22 6v4M22 34v4M6 22h4M34 22h4M10 10l3 3M31 31l3 3M34 10l-3 3M13 31l-3 3"
                                            />
                                            <path
                                                d="M18 44a10 10 0 0 1 10-10 10 10 0 0 1 9.5 7 8 8 0 0 1-1.5 16H20a8 8 0 0 1-2-13z"
                                            />
                                        </svg>
                                    </div>
                                    <div>
                            ...
                            <div class="wx-forecast">
                                <div class="wx-day is-today">
                                    ...
                                    <div class="wx-day-icon">
                                        <svg viewBox="0 0 24 24">
                                            <path
                                                d="M7 18a5 5 0 1 1 1-9.9A6 6 0 0 1 20 11.5 4.5 4.5 0 0 1 19 20.5"
                                            />
                                        </svg>
                                    </div>
                                ...
                                <div class="wx-day">
                                    ...
                                    <div class="wx-day-icon">
                                        <svg viewBox="0 0 24 24">
                                            <path
                                                d="M18 10a6 6 0 0 0-12 0 5 5 0 0 0 0 10h12a5 5 0 0 0 0-10"
                                            />
                                        </svg>
                                    </div>
                                    <div class="wx-day-temp">32°</div>
                                ...
                                <div class="wx-day">
                                    ...
                                    <div class="wx-day-icon">
                                        <svg viewBox="0 0 24 24">
                                            <path
                                                d="M17.7 7.7a6 6 0 1 0-9.1 7.3M3 12h4M15 8h5M18 16h-6M9.5 20h7"
                                            />
                                        </svg>
                                    </div>
                                    <div class="wx-day-temp">28°</div>
