        ...
        939(e, t, a) {
            ...
            function i() {
                (!(function () {
                    ...
                    (function () {
                        const e = (e) => {
                            document
                                .querySelectorAll(".dd-wrap.is-open")
                                .forEach((t) => {
                    ...
                    data: {
                        ...
                        datasets: [
                            ...
                            },
                            {
                                label: "2025",
                                data: [
                                    38, 44, 46, 60, 70, 74, 82, 90, 92, 102,
                                    110, 118,
                                ],
                                borderColor: e.muted,
                        ...
                        datasets: [
                            {
                                label: "Sessions",
                                data: [
                                    120, 132, 110, 145, 162, 158, 175, 188,
                                    172, 195, 210, 224, 218, 240, 256, 248,
                                    272, 290, 282, 308, 322, 318, 340, 358,
            ...
            function u() {
                ...
                (!(function (e) {
                    ((l.t1.defaults.font.family =
                        ...
                        (l.t1.defaults.plugins.legend.labels.usePointStyle =
                            !0),
                        ...
                        (l.t1.defaults.plugins.tooltip.backgroundColor =
                            e.text),
                    ...
                    document
                        .querySelectorAll("canvas[data-chart-key]")
                        .forEach((t) => {
            ...
            function O() {
                (s(),
                    ...
                    (function () {
                        if (!document.querySelector("canvas[data-chart-key]"))
                            return;
                        (u(),
                            new MutationObserver((e) => {
                                e.some(
                                    (e) => "data-theme" === e.attributeName,
                                ) && u();
